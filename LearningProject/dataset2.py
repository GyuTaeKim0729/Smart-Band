...
SIZE = 6667
SEGMENT_SIZE = 60
DATASET_TRAIN_RATIO = 1 

#seldir = ["session11___","session12___","session13___","session1___","session2___","session3___", "session4___", "session5___", "session6___", "session7___", "session8___","session10___"]
...
for dirname in seldir:
    ...
    for filename in labels:
        ...
        for i in range(SEGMENT_SIZE, data.shape[0] + 1):
            a[name].append(data[i - SEGMENT_SIZE:i, :3])
