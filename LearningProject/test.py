...
def run_inference(wanted_words, sample_rate, clip_duration_ms,
  ...
  training_fingerprints = np.load('x_train.npy')
  training_ground_truth = np.load('y_train.npy')
  test_fingerprints = np.load('x_test.npy')
  test_ground_truth = np.load('y_test.npy')

  print(training_fingerprints.shape, training_ground_truth.shape, training_ground_truth)

  tf.logging.set_verbosity(tf.logging.INFO)
  sess = tf.InteractiveSession()
  model_settings = {
    'fingerprint_size': 540,
    'label_count': 30,
    'spectrogram_length': 60,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--checkpoint',
        type=str,
        default='model/best/ds_cnn_9962.ckpt-2000_bnfused',
