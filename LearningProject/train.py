...
def main(_):
    ...
    all_train_fingerprints = np.load('x_train.npy')
    all_train_ground_truth = np.load('y_train.npy')
    all_train_ground_truth = np_utils.to_categorical(all_train_ground_truth)
    all_validation_fingerprints = np.load('x_test.npy')
    all_validation_ground_truth = np.load('y_test.npy')
    ...
    print(all_validation_fingerprints)
    print(all_validation_ground_truth)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=int,
        nargs="+",
        default=[5, 64, 5, 5, 2, 2, 64, 3, 3, 1, 1, 64, 3, 3, 1, 1, 64, 3, 3, 1, 1, 64, 3, 3, 1, 1],
