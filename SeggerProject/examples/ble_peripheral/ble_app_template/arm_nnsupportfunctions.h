 ...
 *
 */
__STATIC_INLINE q31_t arm_nn_sat_doubling_high_mult(const q31_t m1, const q31_t m2)
{
    q31_t result = 0;
 ...
 *
 */
__STATIC_INLINE q31_t arm_nn_divide_by_power_of_two(const q31_t dividend, const q31_t exponent)
{
    q31_t result = 0;
 ...
 *
 */
__STATIC_INLINE q31_t arm_nn_requantize(const q31_t val, const q31_t multiplier, const q31_t shift)
{
...
/**
  ...
  @return        q31 value
 */
__STATIC_INLINE q31_t arm_nn_read_q15x2_ia(const q15_t **in_q15)
{
  q31_t val;
...
/**
  ...
  @return        q31 value
 */
__STATIC_INLINE q31_t arm_nn_read_q7x4_ia(const q7_t **in_q7)
{
  q31_t val;
  memcpy(&val, *in_q7, 4);
  *in_q7 += 4;
...
/**
  ...
  @return        q31 value
 */
__STATIC_INLINE q31_t arm_nn_read_q15x2(const q15_t *in_q15)
{
  q31_t val;
  memcpy(&val, in_q15, 4);
...
/**
  ...
  @return        q31 value
 */
__STATIC_INLINE q31_t arm_nn_read_q7x4(const q7_t *in_q7)
{
  q31_t val;
  memcpy(&val, in_q7, 4);
